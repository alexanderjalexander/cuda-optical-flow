 ...
 */
void
initSobelGaussianKernelMip(float sigma)
{
 ...
 */
void
initHarrisGaussianKernelMip(float sigma)
{
...
sparseLucasKanadeGPUMip(VideoInfo &video, bool async)
{
    ...
    initSobelGaussianKernelMip(SOBEL_MASK_RAD / 3.0f);
    initHarrisGaussianKernelMip(HARRIS_MASK_RAD / 3.0f);
